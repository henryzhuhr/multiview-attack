...
def parse_args():
    ...
    parser.add_argument('config', default='libs/mmdetection/configs/faster_rcnn/faster-rcnn_r101_fpn_2x_coco.py')
    parser.add_argument(
        'checkpoint', default='pretrained/faster_rcnn_r101_fpn_2x_coco_bbox_mAP-0.398_20200504_210455-1d2dac9c.pth'
    )
