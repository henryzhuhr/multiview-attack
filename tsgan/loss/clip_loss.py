...
from tsgan.utils.text_templates import imagenet_templates, part_templates, imagenet_templates_small

LOSS_LIST: Dict[str, nn.Module] = {
...
class DirectionLoss(torch.nn.Module):
    def __init__(self, loss_type='mse'):
        ...
        self.loss_func: nn.Module = LOSS_LIST[loss_type]()
...
class CLIPLoss(torch.nn.Module):
    ...
    def random_patch_centers(self, img_shape, num_patches, size):
        ...
        patch_centers = np.concatenate(
            [
                ...
                np.random.randint(half_size, height - half_size, size=(batch_size * num_patches, 1))
            ],
            axis=1
        )
    ...
    def patch_directional_loss(
        ...
        cosine_dists = 1. - self.patch_direction_loss(
