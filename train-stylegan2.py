...
def train(
    ...
    for idx in pbar:
        ...
        real_img = data_dict["image"].to(device)
        category = data_dict["predict_id"].to(device)
        ...
        fake_pred = discriminator.forward(fake_img)
        real_pred = discriminator.forward(real_img_aug)
